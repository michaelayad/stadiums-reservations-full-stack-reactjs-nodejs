...
const OwnerSignup = () => {
    ...
    const handleSabmit = (event) => {
        ...
        if (nameValid && emailValid && passValid && confirmPassValid && telValid) {
            ...
            axiosInstance.post('/owner', signupData).then((res) => {
                console.log(res)
                ...
                <div className="container p-5">
                    ...
                    >
                        <div className="text-center border-bottom">
                            <h3 className="fw-bold">انشاء حساب كصاحب ستاد</h3>
                        </div>
                        <form onSubmit={(e) => { handleSabmit(e) }}>
                            <div className="row py-3">
                                <div className="col-12 col-md-6 py-2">

                                    <label for="uname" className="form-label">اسم صاحب الاستاد:</label>
                                    <input
                                        type="text"
                                        className={`form-control ${((!nameValid && nameError) ? "is-invalid" : "")} ${((nameValid && !nameError) ? "is-valid" : "")}`}
                                        id="uname"
                                        value={name}
                                        placeholder="اسم صاحب الاستاد"
                                        name="uname"
